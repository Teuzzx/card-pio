...
var CELULAR_ESTABELECIMENTO = "558994661551"
...
cardapio.metodos = {
    ...
    carregarBotaoLigar: () => {
        $('#btnLigar').attr('href', `tel:${CELULAR_ESTABELECIMENTO}`)
    ...
    carregarBotaoWhatsapp: () => {
        ...
        $('#btnWhatsapp').attr('https://www.instagram.com/portallanches00/', URL)
        $('#btnWhatsappFooter').attr('https://www.instagram.com/portallanches00/', URL)
